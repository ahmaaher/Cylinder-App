        ...
        <div style="width:500px; border: 1px solid #aaa; padding: 10px; margin: 10px auto; min-height: 300px">
            <div style="height: 130px; padding-bottom: 30px; border-bottom: 1px dotted #aaa">
                <div style="width: 60%; float: left">
                    ...
                    Radius (r): <input id="radius" type="number" min="0.1" step="0.1" placeholder="Enter value" onkeyup="calculate()"><br><br>
                    Height (h): <input id="height" type="number" min="0.1" step="0.1" placeholder="Enter value" onkeyup="calculate()">
                </div>
